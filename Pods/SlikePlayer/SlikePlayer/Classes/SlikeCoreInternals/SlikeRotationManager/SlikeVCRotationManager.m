...
@implementation SlikeVCRotationManager {
...
- (void)vc_viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id<UIViewControllerTransitionCoordinator>)coordinator {
    ...
    [coordinator animateAlongsideTransition:^(id<UIViewControllerTransitionCoordinatorContext> context) {
        ...
        [self.target activateConstraints:^{
            
            if ( isFull ) {
                [self.target.top_attr equalTo: window.top_attr];
                [self.target.left_attr equalTo: window.left_attr];
                [self.target.right_attr equalTo: window.right_attr];
                [self.target.bottom_attr equalTo: window.bottom_attr];
            } else {
                [self.target.top_attr equalTo: self.superview.top_attr];
                [self.target.left_attr equalTo: self.superview.left_attr];
                [self.target.right_attr equalTo: self.superview.right_attr];
                [self.target.bottom_attr equalTo: self.superview.bottom_attr];
            }
        }];
