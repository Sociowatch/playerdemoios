...
//  Pods
//
//  Created by Aravind kumar on 12/19/17.

#define NETWORK_ERROR                               @"Network is not available"
#define NO_NETWORK                                  @"Network is not available"
#define NO_API_RESPONSE                             @"No api response"
#define NO_VIDEO                                    @"Video is not available"
#define ERR_EMPTY_RESPONSE                          @"Empty response"
...
#define FB_ERROR                                    @"Please provide fb app id."
#define INVALID_INSTANCE_ERROR                      @"Instance should be UIView  class type."
