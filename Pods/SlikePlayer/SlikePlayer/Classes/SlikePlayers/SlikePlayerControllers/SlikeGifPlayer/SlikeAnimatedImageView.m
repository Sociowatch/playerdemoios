...
@interface SlikeAnimatedImageView ()
...
@implementation SlikeAnimatedImageView
...
- (void)setAnimatedImage:(SlikeAnimatedImage *)animatedImage {
...
- (CADisplayLink *)displayLink
{
    if (!_displayLink) {
        ...
        SLWeakProxy *weakProxy = [SLWeakProxy weakProxyForObject:self];
