...
//
//  SlikeMaterialDesignSpinner.m

#import "SlikeMaterialDesignSpinner.h"

static NSString *kSlikeStrokeAnimationKey = @"SlikeMaterialDesignSpinner.stroke";
static NSString *kSlikeRotationAnimationKey = @"SlikeMaterialDesignSpinner.rotation";

@interface SlikeMaterialDesignSpinner ()
@property (nonatomic, readonly) CAShapeLayer *progressLayer;
@property (nonatomic, readwrite) BOOL isAnimating;
@end

@implementation SlikeMaterialDesignSpinner
...
- (void)initialize {
    ...
    self.lineWidth = 3;
    self.duration  = 1;
    self.tintColor = [[UIColor lightGrayColor] colorWithAlphaComponent:1.0];
...
- (void)layoutSubviews {
    ...
    self.progressLayer.frame = CGRectMake(0, 0, 36, 36);
...
- (void)startAnimating {
    ...
    [self.progressLayer addAnimation:animation forKey:kSlikeRotationAnimationKey];
    ...
    [self.progressLayer addAnimation:animations forKey:kSlikeStrokeAnimationKey];
...
- (void)stopAnimating {
    ...
    [self.progressLayer removeAnimationForKey:kSlikeRotationAnimationKey];
    [self.progressLayer removeAnimationForKey:kSlikeStrokeAnimationKey];
